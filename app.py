...
column_ratio = [2, 1, 2]  # Default for desktop
if st.session_state.get('is_mobile', False):
    column_ratio = [1, 0.5, 1]  # Adjusted for mobile
...
st.markdown("©2025 Made With Stremlit By Talal Shoaib | UnitConverter Pro", unsafe_allow_html=True)
st.markdown("</div>", unsafe_allow_html=True)
